...
namespace Czuch
{
	...
	{
	public:
		VulkanOffscreenRenderPass(Camera* cam,VulkanRenderer* renderer, VulkanDevice* device, Format colorFormat, Format depthFormat, U32 width, U32 height, VkSampleCountFlagBits samples = VK_SAMPLE_COUNT_1_BIT, bool handleWindowResize=true);
