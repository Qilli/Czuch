...
namespace Czuch
{
     ...
     bool VulkanPipelineBuilder::BuildPipeline(const RenderPass* renderPass)
    {
		...
		VkPipelineColorBlendAttachmentState colorBlendAttachment = CreateBlendingAttachmentInfo();
        VkPipelineColorBlendStateCreateInfo blendingInfo = CreateBlendingInfo(colorBlendAttachment);
    ...
    VkPipelineColorBlendAttachmentState VulkanPipelineBuilder::CreateBlendingAttachmentInfo()
    {
        ...
        if (pipelineDescPtr->bs.blendSettings.blendEnable == false)
        {
            ...
            // Set to valid default values for non-blended case
            colorBlendAttachment.srcColorBlendFactor = VK_BLEND_FACTOR_ONE;
            colorBlendAttachment.dstColorBlendFactor = VK_BLEND_FACTOR_ZERO;
            colorBlendAttachment.colorBlendOp = VK_BLEND_OP_ADD; // Default operation

            // These are also default values
            colorBlendAttachment.srcAlphaBlendFactor = VK_BLEND_FACTOR_ONE;
            colorBlendAttachment.dstAlphaBlendFactor = VK_BLEND_FACTOR_ZERO;
            colorBlendAttachment.alphaBlendOp = VK_BLEND_OP_ADD; // Default operation
        }
        else
        {
    ...
    VkPipelineColorBlendStateCreateInfo VulkanPipelineBuilder::CreateBlendingInfo(VkPipelineColorBlendAttachmentState& blendInfo)
    {
        ...
        colorBlending.pAttachments = &blendInfo;
