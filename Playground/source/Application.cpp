...
{
	// Odziedziczono za po�rednictwem elementu IEventsListener
...
int main()
{
	...
	settings.debugSettings.SetDebugDrawOBBForMeshesEnabled(true);
	...
	settings.debugSettings.SetDebugDrawSelectedEntityID(planeEntity.GetID());
